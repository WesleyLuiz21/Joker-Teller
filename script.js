...
function tellMe(joke) {
    VoiceRSS.speech({
        key: '236c6f2b35a84296b26875a970f72384',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Miscellaneous,Dark,Pun,Spooky,Christmas?blacklistFlags=nsfw,sexist,explicit'
    try {
